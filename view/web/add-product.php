...
<head>
  <title>Thêm chó | Quản trị Admin</title>
  <meta charset="utf-8">
  ...
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="./product.php"> Danh sách chó</a></li>
        <li class="breadcrumb-item"><a href="#">Thêm chó</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Tạo mới chó</h3>
          <div class="tile-body">
            <div class="row element-button">
              ...
              <div class="col-sm-2">
                <a class="btn btn-add btn-sm" data-toggle="modal" data-target="#addtinhtrangtiemchung"><i class="fas fa-folder-plus"></i> Thêm mới tình trạng tiêm chủng</a>
              </div>
              <div class="col-sm-2">
                <a class="btn btn-add btn-sm" data-toggle="modal" data-target="#addtinhtrangsuckhoe"><i class="fas fa-folder-plus"></i> Thêm tình trạng sức khỏe</a>
              </div>
            </div>
            <form class="row">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="form-group col-md-12">
              <label class="control-label">Danh mục chó hiện đang có</label>
          ...
          <BR>
          <button class="btn btn-save" type="button">Lưu lại</button>
          <a class="btn btn-cancel" data-dismiss="modal" href="./product.php">Hủy bỏ</a>
          <BR>
        </div>
...
-->
  ...
  <!--
  MODAL TÌNH TRẠNG sức khỏe
-->
  <div class="modal fade" id="addtinhtrangtiemchung" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="form-group  col-md-12">
              <span class="thong-tin-thanh-toan">
                <h5>Thêm mới tình trạng tiêm chủng</h5>
              </span>
            </div>
            <div class="form-group col-md-12">
            ...
            <div class="form-group col-md-12">
              <label class="control-label">Tình trạng hiện đang có</label>
              <ul style="padding-left: 20px;">
                <li>Bàn ăn</li>
                <li>Bàn thông minh</li>
                <li>Tủ</li>
...
-->
  ...
  MODAL TÌNH TRẠNG sức khỏe
-->
  <div class="modal fade" id="addtinhtrangsuckhoe" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="form-group  col-md-12">
              <span class="thong-tin-thanh-toan">
                <h5>Thêm mới tình trạng sức khỏe</h5>
              </span>
            </div>
            <div class="form-group col-md-12">
              <label class="control-label">Nhập tình trạng mới</label>
